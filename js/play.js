...
interval(function(){
    console.log(myNetwork.activate([sprite.currentSpeed,sprite.tRex.xPos, sprite.tRex.yPos, sprite.horizon.obstacles.slice(-1)[0].size, sprite.horizon.obstacles.slice(-1)[0].xPos, sprite.horizon.obstacles.slice(-1)[0].yPos]))
}, 500, 1000)
}
